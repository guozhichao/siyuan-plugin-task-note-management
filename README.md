...
为了可持续的维护插件，计划春节后（2026.02.24）对日历视图和项目看板功能以及未来的甘特图视图进行收费：月付5块，年付30块，终身99块，通过思源账户ID绑定会员。其他功能（任务管理侧栏、番茄钟、习惯打卡、四象限面板等等）依然完全免费。收费之后可以把开发成本平摊到每个付费用户上，每个人出一点钱，我就有动力继续去维护和优化插件。
